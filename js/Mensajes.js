function consultar() {
    $.ajax({
        url: "http://129.151.106.231:8080/api/Message/all",
        type: "GET",
        dataType: "JSON",
        //success - propiedad
...
function registrar() {
    ...
    let var2 = {
        ...
        url:"http://129.151.106.231:8080/api/Message/save",
...
function editar() {
    ...
    $.ajax({
        ...
        url: "http://129.151.106.231:8080/api/Message/update",
        type: "PUT",
        data: dataTosend,
...
function eliminar(id) {
    ...
    let dataToSend = JSON.stringify(myData)
    $.ajax({
        url: "http://129.151.106.231:8080/api/Message/" + id.val(),
        type: 'DELETE',
        //data: dataToSend,
        //contentType: "application/JSON",
        datatype: "JSON",
...
function buscarPorID(id) {
    $.ajax({
        url: 'http://localhost:8080/api/Message/' + id.val(),
        dataType: 'json',
        type: 'GET',
