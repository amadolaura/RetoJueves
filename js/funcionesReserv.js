function consultar() {
    ...
    $.ajax({
        url: 'http://129.151.106.231:8080/api/Reservation/all',
        type: 'GET',
        dataType: 'JSON',
...
function registrar() {
    ...
    let var2 = {
        ...
        url:"http://129.151.106.231:8080/api/Reservation/save",
...
function editar() {
    ...
    $.ajax({
        ...
        url: "http://129.151.106.231:8080/api/Reservation/update",
        type: "PUT",
        data: dataTosend,
...
function eliminar(id) {
    ...
    let dataToSend = JSON.stringify(myData)
    $.ajax({
        url: "http://129.151.106.231:8080/api/Reservation/" + id.val(),
        type: 'DELETE',
        //data: dataToSend,
        //contentType: "application/JSON",
        datatype: "JSON",
